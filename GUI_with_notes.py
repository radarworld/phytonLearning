...
#The ttk module contains different versions of most of the standard Tkinter widgets.
...
class App:
    ...
    def __init__(self, root):
        ...
        # w = PanedWindow( master, option, ... ); master − This represents the parent window.
        # VERTICAL:the panes will be under each other. 
        vertical_pane = ttk.PanedWindow(self.root, orient=VERTICAL)

        #place vertical pane to row=0, col=0
        #Defines how to expand the widget if the resulting cell is larger than the widget itself.
        #This can be any combination of the constants S, N, E, and W, or NW, NE, SW, and SE. 
        vertical_pane.grid(row=0, column=0, sticky="nsew")

        #create horizontal pane and append vertical pane to it
...
#By doing the main check, you can have that code only execute when you want to
#run the module as a program and not have it execute when someone just wants to
